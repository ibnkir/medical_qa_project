...
def find_similar_questions(user_text: str, questions_num: int, is_cls_needed: bool) -> dict:
    ...
    Args:
        ...
        is_cls_needed (bool): Нужно ли использовать классификатор для фильтрации найденных вопросов.
